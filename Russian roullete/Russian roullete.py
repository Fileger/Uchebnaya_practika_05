...
class play:
    def modes_1():
        ...
        btn = Button(frame, image=photo1, borderwidth=0, activebackground='white', bg='white', command=lambda: play.toggle_image(current_state, current_state2, btn, photo2, btn2, photo1_a))
        btn.image = photo1
        ...
        btn2 = Button(frame, image=photo1_a, activebackground='white',  command=lambda: play.toggle_image2(current_state2,current_state, btn2, photo2_b, btn, photo1), borderwidth=0, bg='white')
        btn2.image = photo1_a
        ...
        photo4 = ImageTk.PhotoImage(image3)
        label4 = Label(root, image=photo3, bg='white')
        label4.image = photo4
        btn4 = Button(frame, image=photo3, activebackground='white', borderwidth=0, bg='white', command=main_menu)
        btn4.place(x=20, y=725)
        ...
        btn1 = Button(frame, image=photo11, borderwidth=0, activebackground='white', bg='white', command=lambda: play.toggle_image1(current_state1, current_state21, btn1, photo21, btn21, photo1_a1))
        btn1.image = photo1
        btn1.place(x=400, y=440)
        btn21 = Button(frame, image=photo1_a1, activebackground='white', command=lambda: play.toggle_image21(current_state21, current_state1, btn21, photo2_b1, btn1, photo11), borderwidth=0, bg='white')
...
def main_menu():
    ...
    btn1 = Button(frame, text='ИГРАТЬ', font=("Arial", 15), command=play.modes_1)
