...
class game:
    def roulette_1():
        ...
        btn5 = Button(frame, text='ВЫСТРЕЛИТЬ В ПРОТИВНИКА', font=("Arial", 15))
        btn5.place(relx=0.18, rely=0.85, relwidth=0.27, relheight=0.13)
        btn4 = Button(frame, text='ВЫСТРЕЛИТЬ В СЕБЯ', font=("Arial", 15))
    ...
    def roulette_2():
        ...
        canvas.create_image(600, 179, image=opp)
