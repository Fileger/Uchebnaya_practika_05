...
def rule():
    ...
    rules = Label(
        ...
        text=(
            ...
            "Рейтинг увеличивается за каждую победу. Максимум — 98. При следующем увеличении или при выходе в меню рейтинг сбрасывается до 0."
        ),
        bg='white',
        font=("Arial", 13),
        justify=LEFT,
...
class modes:
    ...
    def mode_roulette():
        ...
        patron_img = ImageTk.PhotoImage(Image.open("pngwing.com (8).png").resize((180, 180)))
        drum_imgs = [ImageTk.PhotoImage(Image.open("pngwing.com-_7_1.bmp").resize((310, 310))),
            ImageTk.PhotoImage(Image.open("pngwing.com-_7_2.bmp").resize((310, 310))),
            ImageTk.PhotoImage(Image.open("pngwing.com-_7_3.bmp").resize((310, 310))),
            ImageTk.PhotoImage(Image.open("pngwing.com-_7_4.bmp").resize((310, 310))),
            ImageTk.PhotoImage(Image.open("pngwing.com-_7_5.bmp").resize((310, 310)))]
...
class game:
    def roulette_1():
        ...
        image4 = Image.open("pngwing.com (11).png")
        image4 = image4.resize((200, 200))
        photo4 = ImageTk.PhotoImage(image4)
        label4 = Label(root, image=photo4, bg='white')
        label4.image = photo4

        image5 = Image.open("pngwing.com (2).png")
        ...
        def shoot():
            ...
            root.after(800, lambda: result(root))
    ...
    def shotgun_1():
        ...
        heart_img = ImageTk.PhotoImage(Image.open("pngwing.com (1).png").resize((50, 50)))
        ...
        def hide_blank_info():
            ...
            if label_info:
                ...
                if q==1:
                    ...
                    a = random.randint(1, n)
        def opp_shot():
            global n, a, rating_1, blank_patron, life_1, life_2, k, q
            q=2
            k=1
            if a > blank_patron:
                life_2 -= 1
        ...
        def shot():
            global a, blank_patron, life_1, life_2, n, rating_1, k, q
            k =1
            q=2
    ...
    def shotgun_2():
        ...
        def opp_shot():
            global n, a, rating_1, blank_patron, life_1, life_2, player, rating_2, k
            k=1
            if player==1:
                if a > blank_patron:
                    life_2 -= 1
        ...
        def shot():
            global a, blank_patron, life_1, life_2, n, rating_1, rating_2, player, k
            k=1
            if player==1:
                if a > blank_patron:
                    life_1 -= 1
...
class settings:
    def settings():
        clear_window()
        img1 = Image.open("3039404.png").resize((210, 210))
        photo1 = ImageTk.PhotoImage(img1)
        img2 = Image.open("ff.png").resize((269, 244))
        photo2 = ImageTk.PhotoImage(img2)
        current_state = {"image": 1}
        ...
        img2_a = Image.open("pngwing.com.png").resize((240, 240))
        photo1_a = ImageTk.PhotoImage(img2_a)
        img2_b = Image.open("gg.png").resize((310, 280))
        photo2_b = ImageTk.PhotoImage(img2_b)
        current_state2 = {"current": 1}
